...
const DetailsBar = () => {
  return (
    <DetailsBarWrapper>
      ...
      <div>
        <ContactsWrapper href="tel:+251-963-357-998">
          <Icon.Phone size={15} color="rgb(252, 113, 137)" />
          <ContactText>+251-963-357-998</ContactText>
        </ContactsWrapper>

        <ContactsWrapper href="mailto:amanuelgirma360@gmail.com">
          <Icon.Mail size={15} color="rgb(252, 113, 137)" />
          <ContactText>amanuelgirma360@gmail.com</ContactText>
        </ContactsWrapper>
      </div>
      ...
      <SocialsWrapper>
        <SocialIconWrapper href="https://github.com/BamanGirma">
          <Icon.GitHub color="#fff" size={20} />
        </SocialIconWrapper>
        <SocialIconWrapper href="https://www.linkedin.com/in/amanuel-girma-436b092a7/">
          <Icon.Linkedin color="#fff" size={20} />
        </SocialIconWrapper>
        <SocialIconWrapper href="https://www.instagram.com/bamani_gr/">
